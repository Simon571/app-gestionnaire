...
import { useSecureBackupSyncService } from '@/lib/secure-backup-sync-service';
...
const PrivacySecurityContent = () => {
  ...
  const secureBackupFunctions = useSecureBackupSyncService();
  const {
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={handleExportData} disabled={loading} className="bg-blue-600 hover:bg-blue-700">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Supprimez définitivement toutes vos données personnelles</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Transférez vos données vers un autre service</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-gray-600">
                Vous pouvez à tout moment demander le transfert de vos données vers un autre service compatible.
              </p>
              <p className="text-sm text-gray-600">Contactez-nous: privacy@app-gestionnaire.com</p>
            </CardContent>
          </Card>
        </div>
      )}
      ...
      {activeTab === 'audit' && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Toutes les actions effectuées sur votre compte</CardDescription>
          </CardHeader>
          <CardContent>
            {auditLogs.length === 0 ? (
